...
class SiteController extends Controller
{
    ...
    {
        $model = new SignupForm();
        return $this->render('how', ['model'=>$model]);
    }
    ...
    {
        $model = new SignupForm();
        return $this->render('organization', ['model'=>$model]);
    }
    ...
    public function actionSignup()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->signup()) {
            Yii::$app->session->setFlash('success', 'Мы отправили письмо на указанный Email, пожалуйста, пройдите верификацию.');
